    ...
    <div class="container">
      <div id="productsBanner" class="carousel slide mb-2" data-ride="carousel">
        <ol class="carousel-indicators">
          <li data-target="#productsBanner" data-slide-to="0" class="active"></li>
          <li data-target="#productsBanner" data-slide-to="1"></li>
        </ol>
        ...
        <a class="carousel-control-prev" href="#productsBanner" role="button" data-slide="prev">
          <span class="carousel-control-prev-icon" aria-hidden="true"></span>
          <span class="sr-only">Previous</span>
        </a>
        <a class="carousel-control-next" href="#productsBanner" role="button" data-slide="next">
